...
export function DialogDemo() {
  ...
  return (
    <Dialog className="" open={open}  >
      <DialogTrigger >
        <Button variant="outline" className="flex flex-col w-[100%] h-[100%] hover:bg-white px-2 py-4 font-normal" onClick={
          ()=>setOpen(true)
        }><Plus />
        <p>Add Lead Source</p>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 gap-y-6 ">
          <LeadList setOpen={setOpen}/>
          <div className="border hover:bg-slate-200 shadow-md  p-2 rounded-md flex justify-center items-center gap-4" onClick={()=>setOpen(false)}>
          ...
          <div className="border  shadow-md hover:bg-slate-200 p-2 rounded-md flex justify-center items-center gap-4" onClick={()=>setOpen(false)}>
